...
import { CosmosChainId, ChainId, EthereumChainId, Msgs } from '../../../';
import type Web3 from 'web3';
import { Wallet, WalletDeviceType } from '../../types/enums';
import { TxToSend } from '../../../tx-ts/ethermint/types';
export declare type onAccountChangeCallback = (account: string) => void;
export declare type onChainIdChangeCallback = () => void;
...
export interface WalletStrategyArguments extends Omit<CosmosWalletStrategyArguments, 'endpoints' | 'chainId'> {
    chainId: ChainId;
    ethereumOptions?: WalletStrategyEthereumOptions;
    disabledWallets?: Wallet[];
    wallet?: Wallet;
}
export interface ConcreteWalletStrategy extends Omit<ConcreteCosmosWalletStrategy, 'sendTransaction' | 'signTransaction' | 'isChainIdSupported'> {
    /**
     * Sends Cosmos transaction. Returns a transaction hash
     * @param transaction should implement TransactionConfig
     * @param options
