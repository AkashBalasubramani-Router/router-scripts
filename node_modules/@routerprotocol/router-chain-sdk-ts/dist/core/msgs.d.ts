...
import { MsgExecuteContract, MsgInstantiateContract, MsgStoreCode, MsgUpdateAdmin, MsgMigrateContract } from './wasm';
import { MsgWithdrawDelegatorReward } from './distribution';
import { MsgApproveFeepayerRequest } from './metastore';
import { MsgCwStoreCode, MsgExecuteCwContract, MsgInstantiateCwContract, MsgMigrateCwContract } from './rwasm';
/**
 * @group Message
 */
export declare type Msgs = MsgGrant | MsgRevoke | MsgAuthzExec | MsgSend | MsgGovDeposit | MsgSubmitProposal | MsgVote | MsgTransfer | MsgDelegate | MsgUndelegate | MsgWithdrawDelegatorReward | MsgBeginRedelegate | MsgStoreCode | MsgCwStoreCode | MsgInstantiateContract | MsgInstantiateCwContract | MsgExecuteContract | MsgExecuteCwContract | MsgUpdateAdmin | MsgMigrateContract | MsgMigrateCwContract | MsgApproveFeepayerRequest;
