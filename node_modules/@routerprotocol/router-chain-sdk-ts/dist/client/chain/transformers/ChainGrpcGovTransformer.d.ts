import { QueryParamsResponse as QueryGovernanceParamsResponse, QueryProposalsResponse, QueryProposalResponse, QueryDepositsResponse, QueryTallyResultResponse, QueryVotesResponse } from '@routerprotocol/chain-api/cosmos/gov/v1beta1/query_pb';
import { GovModuleStateParams, Proposal, GrpcProposal, ProposalDeposit, Vote, TallyResult, GrpcTallyResult, GrpcGovernanceDepositParams, GrpcGovernanceVotingParams, GrpcGovernanceTallyParams } from '../types/custom/gov';
