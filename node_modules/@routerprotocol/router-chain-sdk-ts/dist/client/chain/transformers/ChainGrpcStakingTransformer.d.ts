import { QueryDelegatorDelegationsResponse, QueryDelegatorUnbondingDelegationsResponse, QueryRedelegationsResponse, QueryValidatorsResponse, QueryDelegationResponse, QueryValidatorResponse, QueryParamsResponse as QueryStakingParamsResponse, QueryPoolResponse } from '@routerprotocol/chain-api/cosmos/staking/v1beta1/query_pb';
import { GrpcValidator, GrpcValidatorCommission, GrpcValidatorDescription, BondStatus, Validator, ValidatorCommission, ValidatorDescription, Delegation, UnBondingDelegation, ReDelegation, Pool, StakingModuleParams } from '../types/custom/staking';
