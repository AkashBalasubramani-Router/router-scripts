...
var Msg = (function () {
  function Msg() {}
  Msg.serviceName = "ethermint.evm.v1.Msg";
  return Msg;
}());
...
MsgClient.prototype.ethereumTx = function ethereumTx(requestMessage, metadata, callback) {
  if (arguments.length === 2) {
    callback = arguments[1];
  }
  var client = grpc.unary(Msg.EthereumTx, {
