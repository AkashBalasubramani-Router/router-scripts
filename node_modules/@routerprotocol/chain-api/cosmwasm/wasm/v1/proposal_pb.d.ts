...
export class StoreAndInstantiateContractProposal extends jspb.Message {
  getTitle(): string;
  setTitle(value: string): void;
  ...
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): StoreAndInstantiateContractProposal.AsObject;
  static toObject(includeInstance: boolean, msg: StoreAndInstantiateContractProposal): StoreAndInstantiateContractProposal.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: StoreAndInstantiateContractProposal, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): StoreAndInstantiateContractProposal;
  static deserializeBinaryFromReader(message: StoreAndInstantiateContractProposal, reader: jspb.BinaryReader): StoreAndInstantiateContractProposal;
}
