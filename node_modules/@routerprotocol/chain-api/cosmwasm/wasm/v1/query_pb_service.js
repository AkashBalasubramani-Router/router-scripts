...
Query.ContractsByCreator = {
  methodName: "ContractsByCreator",
  service: Query,
  requestStream: false,
  responseStream: false,
  requestType: cosmwasm_wasm_v1_query_pb.QueryContractsByCreatorRequest,
  responseType: cosmwasm_wasm_v1_query_pb.QueryContractsByCreatorResponse
};
...
QueryClient.prototype.contractsByCreator = function contractsByCreator(requestMessage, metadata, callback) {
  if (arguments.length === 2) {
    callback = arguments[1];
  }
  var client = grpc.unary(Query.ContractsByCreator, {
    request: requestMessage,
    host: this.serviceHost,
    metadata: metadata,
    transport: this.options.transport,
