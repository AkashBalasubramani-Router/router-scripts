 ...
 * @const
 */
proto.cosmwasm.wasm.v1.Contract.repeatedFields_ = [3,4];
...
proto.cosmwasm.wasm.v1.Contract.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    contractCodeHistoryList: jspb.Message.toObjectList(msg.getContractCodeHistoryList(),
...
proto.cosmwasm.wasm.v1.Contract.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 4:
      ...
      msg.addContractCodeHistory(value);
      break;
    default:
      reader.skipField();
      break;
...
proto.cosmwasm.wasm.v1.Contract.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getContractCodeHistoryList();
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      4,
      f,
 ...
 */
proto.cosmwasm.wasm.v1.Contract.prototype.getContractCodeHistoryList = function() {
  return /** @type{!Array<!proto.cosmwasm.wasm.v1.ContractCodeHistoryEntry>} */ (
    jspb.Message.getRepeatedWrapperField(this, cosmwasm_wasm_v1_types_pb.ContractCodeHistoryEntry, 4));
};
 ...
 * @return {!proto.cosmwasm.wasm.v1.Contract} returns this
*/
proto.cosmwasm.wasm.v1.Contract.prototype.setContractCodeHistoryList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 4, value);
};
 ...
 */
proto.cosmwasm.wasm.v1.Contract.prototype.addContractCodeHistory = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 4, opt_value, proto.cosmwasm.wasm.v1.ContractCodeHistoryEntry, opt_index);
};
 ...
 * @return {!proto.cosmwasm.wasm.v1.Contract} returns this
 */
proto.cosmwasm.wasm.v1.Contract.prototype.clearContractCodeHistoryList = function() {
  return this.setContractCodeHistoryList([]);
};
