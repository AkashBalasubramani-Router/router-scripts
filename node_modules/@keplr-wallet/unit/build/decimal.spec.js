...
describe("Test decimals", () => {
    // (2 ** (256 + 60) - 1) / (10 ** 18)
    const maxDec = "133499189745056880149688856635597007162669032647290798121690100488888732861290.034376435130433535";
    // maxDec + 0.000000000000000001
    const overflowedDec = "133499189745056880149688856635597007162669032647290798121690100488888732861290.034376435130433536";
    it("dec should be parsed properly", () => {
        expect(() => new decimal_1.Dec(1, 0)).not.toThrow();
        expect(() => new decimal_1.Dec(1, -1)).toThrow();
        expect(() => new decimal_1.Dec(1, decimal_1.Dec.precision)).not.toThrow();
        expect(() => new decimal_1.Dec(1, decimal_1.Dec.precision + 1)).toThrow();
        ...
        dec = new decimal_1.Dec(10);
        expect(dec.toString()).toBe("10.000000000000000000");
        dec = new decimal_1.Dec(10.009);
        expect(dec.toString()).toBe("10.009000000000000000");
        expect(dec.toString(2)).toBe("10.00");
        dec = new decimal_1.Dec(-123.456789);
        expect(dec.toString()).toBe("-123.456789000000000000");
        expect(dec.toString(3)).toBe("-123.456");
        expect(() => {
            new decimal_1.Dec("");
    ...
    it("Test Dec overflow", () => {
        expect(new decimal_1.Dec(maxDec).toString()).toBe(maxDec);
        expect(new decimal_1.Dec("-" + maxDec).toString()).toBe("-" + maxDec);
        expect(() => new decimal_1.Dec(overflowedDec)).toThrow();
        expect(() => new decimal_1.Dec("-" + overflowedDec)).toThrow();
        const max = new decimal_1.Dec(maxDec);
        expect(() => max.add(new decimal_1.Dec(1, decimal_1.Dec.precision))).toThrow();
        const min = new decimal_1.Dec("-" + maxDec);
        expect(() => min.sub(new decimal_1.Dec(1, decimal_1.Dec.precision))).toThrow();
    });
    it("Test Dec neg/abs", () => {
        expect(new decimal_1.Dec(1).neg().toString()).toBe("-1.000000000000000000");
        expect(new decimal_1.Dec(1).neg().equals(new decimal_1.Dec(-1))).toBe(true);
        expect(new decimal_1.Dec(-1).neg().toString()).toBe("1.000000000000000000");
        expect(new decimal_1.Dec(-1).neg().equals(new decimal_1.Dec(1))).toBe(true);
        expect(new decimal_1.Dec(1).abs().toString()).toBe("1.000000000000000000");
        expect(new decimal_1.Dec(1).abs().equals(new decimal_1.Dec(1))).toBe(true);
        expect(new decimal_1.Dec(-1).abs().toString()).toBe("1.000000000000000000");
        expect(new decimal_1.Dec(-1).abs().equals(new decimal_1.Dec(1))).toBe(true);
    });
    it("Test Dec isPositive/isNegative/isInteger/isZero", () => {
        expect(new decimal_1.Dec(1).isPositive()).toBe(true);
        expect(new decimal_1.Dec(-1).isPositive()).toBe(false);
        expect(new decimal_1.Dec(1).isNegative()).toBe(false);
        expect(new decimal_1.Dec(-1).isNegative()).toBe(true);
        expect(new decimal_1.Dec(1).isInteger()).toBe(true);
        expect(new decimal_1.Dec(-1).isInteger()).toBe(true);
        expect(new decimal_1.Dec(1.1).isInteger()).toBe(false);
        expect(new decimal_1.Dec(-1.1).isInteger()).toBe(false);
        expect(new decimal_1.Dec(0).isZero()).toBe(true);
        expect(new decimal_1.Dec(-0).isZero()).toBe(true);
        expect(new decimal_1.Dec(-1.1).isZero()).toBe(false);
        expect(new decimal_1.Dec(1.1).isZero()).toBe(false);
    });
    it("Test Dec comparison", () => {
        const dec1 = new decimal_1.Dec(1);
        const dec2 = new decimal_1.Dec(2);
        ...
        const tests = [
            {
                ...
                i1: new int_1.Int(12),
                exp: new decimal_1.Dec(0),
            },
            {
                d1: new decimal_1.Dec(0),
                i1: new int_1.Int(0),
                exp: new decimal_1.Dec(1),
            },
            {
                d1: new decimal_1.Dec(12),
                i1: new int_1.Int(0),
                exp: new decimal_1.Dec(1),
            },
            {
            ...
            },
            {
                d1: new decimal_1.Dec(-12),
                i1: new int_1.Int(1),
                exp: new decimal_1.Dec(-12),
            },
            {
                d1: new decimal_1.Dec(-12),
                i1: new int_1.Int(2),
                exp: new decimal_1.Dec(144),
            },
            {
                d1: new decimal_1.Dec(12),
                i1: new int_1.Int(3),
                exp: new decimal_1.Dec(1728),
            },
            {
                d1: new decimal_1.Dec(12),
                i1: new int_1.Int(-1),
                exp: new decimal_1.Dec("0.083333333333333333"),
            },
            {
                d1: new decimal_1.Dec(12),
                i1: new int_1.Int(-2),
                exp: new decimal_1.Dec("0.006944444444444444"),
            },
            {
                d1: new decimal_1.Dec(12),
                i1: new int_1.Int(-3),
                exp: new decimal_1.Dec("0.000578703703703704"),
            },
            {
                d1: new decimal_1.Dec(10),
                i1: new int_1.Int(4),
                exp: new decimal_1.Dec("10000"),
            },
            {
                d1: new decimal_1.Dec(10),
                i1: new int_1.Int(5),
                exp: new decimal_1.Dec("100000"),
            },
            {
                d1: new decimal_1.Dec(10),
                i1: new int_1.Int(-5),
                exp: new decimal_1.Dec("0.00001"),
            },
        ];
    ...
    it("Test Dec approxRoot", () => {
        const tests = [
            { d: new decimal_1.Dec(1), r: 10, res: new decimal_1.Dec(1) },
            { d: new decimal_1.Dec(25, 2), r: 2, res: new decimal_1.Dec(5, 1) },
            { d: new decimal_1.Dec(4, 2), r: 2, res: new decimal_1.Dec(2, 1) },
            { d: new decimal_1.Dec(27), r: 3, res: new decimal_1.Dec(3) },
            { d: new decimal_1.Dec(-81), r: 4, res: new decimal_1.Dec(-3) },
            { d: new decimal_1.Dec(2), r: 2, res: new decimal_1.Dec("1414213562373095049", 18) },
            {
                d: new decimal_1.Dec(1005, 3),
                r: 31536000,
                res: new decimal_1.Dec("1.000000000158153904"),
            },
            { d: decimal_1.Dec.smallestDec, r: 2, res: new decimal_1.Dec(1, 9) },
            { d: decimal_1.Dec.smallestDec, r: 3, res: new decimal_1.Dec("0.000000999999999997") },
            { d: new decimal_1.Dec(1, 8), r: 3, res: new decimal_1.Dec("0.002154434690031900") },
        ];
        for (const test of tests) {
    ...
    it("dec should be round up properly", () => {
        ...
        for (const test of tests) {
            ...
            expect(resPosDec.toString()).toBe(test.exp.toString() + ".000000000000000000");
        }
    });
    it("dec should be round properly", () => {
        ...
        for (const test of tests) {
            ...
            expect(resNegDec.toString()).toBe(test.exp.neg().toString() + ".000000000000000000");
    ...
    it("dec should be parsed to string properly", () => {
        const tests = [
            ...
            {
                d1: new decimal_1.Dec(new int_1.Int("1")),
                precision: 5,
                exp: "1.00000",
            },
            {
    ...
    it("Test case that input decimals exceeds 18", () => {
        const tests = [
            {
                ...
                res: new decimal_1.Dec("0.489234893284938249"),
                resStr: "0.489234893284938249",
            },
            {
                input: 0.0000010000000249348,
                res: new decimal_1.Dec("0.000001000000024934"),
        ...
        for (const test of tests) {
            const dec = new decimal_1.Dec(test.input);
    ...
    it("Test Int/Uint from exponent number", () => {
        const tests = [
            {
                ...
                expect: new decimal_1.Dec("12345678901234568000000"),
            },
            {
                num: -12345678901234567890123,
                str: "-1.2345678901234568e+22",
            ...
            },
            {
                num: 0.0000000000001,
                str: "1e-13",
                expect: new decimal_1.Dec("0.0000000000001"),
            },
            {
                num: 0.000000000000123,
                str: "1.23e-13",
                expect: new decimal_1.Dec("0.000000000000123"),
            },
            {
                num: 0.000000000000000001,
                str: "1e-18",
                expect: new decimal_1.Dec("0.000000000000000001"),
            },
            {
                num: 0.0000000000000000001,
                str: "1e-19",
                expect: new decimal_1.Dec("0"),
            },
            {
        ...
        for (const test of tests) {
            ...
            expect(new decimal_1.Dec(test.num).equals(test.expect)).toBe(true);
        }
    });
});
