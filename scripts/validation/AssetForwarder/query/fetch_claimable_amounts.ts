...
export async function fetch_claimable_amounts(env: string) {
  if (env == "devnet") {
  ...
  let function1 = toUtf8(
    JSON.stringify({
      fetch_claimable_amounts: {
        forwarder: "router1d95k9q8hnugcg50sf075x2l6tz8uy4rzlsekk8",
      },
    })
  );
